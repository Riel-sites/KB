...
function grax_tm_modalbox_news(){
	...
	var modalBox	= jQuery('.kob_tm_modalbox_news');
	var list 		= jQuery('.kob_tm_news .news_list ul li');
	var closePopup	= modalBox.find('.close');
	
	list.each(function(){
		var element 	= jQuery(this);
		var details 	= element.find('.list_inner').html();
		var buttons 	= element.find('.details .title a,.kob_tm_full_link');
...
function grax_tm_popupscroll(){
	...
	var popupBox		= jQuery('.kob_tm_modalbox_news .description_wrap');
...
function grax_tm_color_switcher(){
	...
	var list	= jQuery('.kob_tm_settings .colors li a');

	list.on('click',function(){
		var element = jQuery(this);
		var elval	= element.attr('class');
		element.closest('.kob_tm_all_wrap').attr('data-color',''+elval+'');
		return false;
	});	
}
...
function grax_tm_switcher_opener(){
	...
	var settings	= jQuery('.kob_tm_settings');
	...
	button.on('click',function(){
		...
		if(element.hasClass('opened')){
			...
			element.closest('.kob_tm_settings').removeClass('opened');
		}else{
			element.addClass('opened');
			element.closest('.kob_tm_settings').addClass('opened');
		}
		return false;
	});
	...
	dark.on('click',function(){
		...
		jQuery('.kob_tm_partners').addClass('opened');
		el.closest('.kob_tm_settings').addClass('changed');
		return false;
	});
	...
	light.on('click',function(){
		...
		jQuery('.kob_tm_partners').removeClass('opened');
		ele.closest('.kob_tm_settings').removeClass('changed');
		return false;
	});
}
...
function grax_tm_cursor_switcher(){
	...
	var wrapper		= jQuery('.kob_tm_all_wrap');
	var button		= jQuery('.kob_tm_settings .cursor li a');
	var show		= jQuery('.kob_tm_settings .cursor li a.show');
	var hide		= jQuery('.kob_tm_settings .cursor li a.hide');
...
function grax_tm_hero_title_fade(){
	...
	setTimeout(function(){
		jQuery('.kob_tm_topbar').addClass('opened');
		jQuery('.kob_tm_down').addClass('opened');
	},a+wait);
}
...
function grax_tm_nav_bg(){
	...
	jQuery(window).on('scroll',function(){
		...
		var topbar	 		= jQuery('.kob_tm_topbar');
...
function grax_tm_down(){
	...
	jQuery('.kob_tm_talk .button a').on('click',function(){
		if($.attr(this, 'href') !== '#'){
			$('html, body').animate({
...
function grax_tm_hamburger(){
	...
	var mobileMenu		= jQuery('.kob_tm_mobile_menu .dropdown');
	...
	jQuery('.kob_tm_mobile_menu .dropdown .dropdown_inner ul li a').on('click',function(){
		jQuery('.hamburger').removeClass('is-active');
		jQuery('.kob_tm_mobile_menu .dropdown').slideUp();
		return false;
	});
}
